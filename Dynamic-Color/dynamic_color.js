...
var kd_points = [];
var kd;
function loadC3Data(uri = './lib/c3_data.json') {
    const filePath = uri;
...
if (require.main === module) {
    loadC3Data('./lib/c3_data.json')
        .then(() => main())
        .catch((err) => console.error("Failed to load c3 data:", err));
}

module.exports = { DynamicColor, loadC3Data, d3 };
